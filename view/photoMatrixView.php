<div class="panel panel-default">
	...
	<div class="panel-heading">
		<a class="btn btn-default" href="index.php?controller=photoMatrix&action=prevAction&imgId=<?= $data["imgId"] ?>&size=<?= $data["imgSize"] ?>"><i class="fa fa-arrow-left" aria-hidden="true"></i> Prev</a>
